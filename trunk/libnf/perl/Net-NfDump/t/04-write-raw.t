...
# testing v4
my $flow_v4 = new Net::NfDump(OutputFile => "t/record_v4.out", RawData => 1 );
$flow_v4->create();
$flow_v4->write(\%rec_v4);
$flow_v4->close();


my $flow_v4i = new Net::NfDump(InputFiles => [ "t/record_v4.out" ], RawData => 1 );
$flow_v4i->query();
...
# testing v6
my $flow_v6 = new Net::NfDump(OutputFile => "t/record_v6.out", RawData => 1 );
$flow_v6->create();
$flow_v6->write(\%rec_v6);
$flow_v6->close();

my $flow_v6i = new Net::NfDump(InputFiles => [ "t/record_v6.out" ], RawData => 1 );
$flow_v6i->query();
